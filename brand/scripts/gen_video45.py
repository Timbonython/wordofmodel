...
def hook_a(w, h, pad, eyebrow_size, head_size, box_size, sub_size, foot_size,
           gap1, gap2, gap3, top_pad, bottom_pad):
    caret_css = f"""
  ...
  <div class="rule" id="rule" style="height:{int(w*0.011)}px;background:var(--ink);opacity:0"></div>
  ...
  <div style="flex:1;display:flex;flex-direction:column;justify-content:center">
    ...
    <div class="anim" id="box" style="border:{max(2,int(w*0.003))}px solid var(--ink);background:#fff;padding:{int(box_size*0.85)}px {int(box_size*0.95)}px;min-height:{int(box_size*4.4)}px">
...
def hook_c(w, h, pad, eyebrow_size, head_size, card_pad, row_size, sub_size, foot_size,
  ...
  <div class="rule" id="rule" style="height:{int(w*0.011)}px;background:var(--green);opacity:0"></div>
...
JOBS = [
    ("wom-video-A-selfcheck-1080x1350", 1080, 1350, 8.5, A_TIMELINE,
    ...
    ("wom-video-C-rival-1080x1350", 1080, 1350, 9.5, C_TIMELINE,
